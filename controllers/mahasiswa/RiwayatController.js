...
const getDetailPeminjaman = async (req, res) => {
  try {
    ...
    const responseData = {
      ...
      tanggal_wajib_pengembalian: formatTanggal(detailPeminjaman.tanggal_wajib_pengembalian),
      tanggal_pengembalian: detailPeminjaman.tanggal_pengembalian ? formatTanggal(detailPeminjaman.tanggal_pengembalian) : null,
